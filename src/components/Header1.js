...
const Header1 = () => {
  return (
    <div className="flex flex-col">
      <div className="relative flex flex-col-reverse justify-center items-start bg-slate-800  p-6 rounded-2xl shadow-[0_40px_90px_-30px_rgba(0,0,0,0.15)] shadow-black text-right mx-auto mb-1 w-[80%] mt-5 md:flex-row">
